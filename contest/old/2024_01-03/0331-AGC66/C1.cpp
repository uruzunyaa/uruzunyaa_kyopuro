	...
	rep(z,t){
		...
		rep(i,s.size()){
			...
			if(d.size()==3){
				...
				if(d.at(d.size()-3)=='A'&&d.at(d.size()-2)=='A'&&d.at(d.size()-1)=='B'){
					d.pop_back();
					d.pop_back();
					d.pop_back();
					ans++;
				}else if(d.at(d.size()-4)=='A'&&d.at(d.size()-3)=='B'&&d.at(d.size()-2)=='A'&&d.at(d.size()-1)=='A'){
					d.pop_back();
					d.pop_back();
					d.pop_back();
					ans++;
		...
		while(d.size()!=0){
			...
			d.pop_back();
			if(e.size()>=3){
				if(e.at(e.size()-3)=='A'&&e.at(e.size()-2)=='A'&&e.at(e.size()-1)=='B'){
					e.pop_back();
					e.pop_back();
					e.pop_back();
					ans++;
				}else if(e.at(e.size()-3)=='B'&&e.at(e.size()-2)=='A'&&e.at(e.size()-1)=='A'){
					e.pop_back();
					e.pop_back();
					e.pop_back();
					ans++;
