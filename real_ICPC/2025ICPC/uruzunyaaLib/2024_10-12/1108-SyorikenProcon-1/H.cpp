...
int main(){
	...
	while(q--){
		...
		if(t==1){
			...
			p--,c--;
			ll ans=0;
			rep(i,m)if(s[p][i]=='1'&&s[c][i]=='1')ans++;
			cout<<ans<<endl;
		}else if(t==6){
			ll p,c;
			cin>>p>>c;
			...
			p--,c--;
			ll ans=0;
			rep(i,m)if((s[p][i]=='1'&&s[c][i]=='0')||(s[p][i]=='0'&&s[c][i]=='1'))ans++;
			cout<<ans<<endl;
		}else{
			ll p,c;
			cin>>p>>c;
			p--,c--;
			ll ans=0;
			rep(i,m)if(s[p][i]=='1'&&s[c][i]=='0')ans++;
			cout<<ans<<endl;
		}
	}	
	return 0;
