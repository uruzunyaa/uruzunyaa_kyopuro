...
struct SegTree{
	...
	//セグ木デバッグ用、丸ごと出力
	void print(){
		rep(i,size)cout<<setw(15)<<left<<i;
		cout<<endl;
		ll pos=size;
		rep(i,tall){
			rep(j,size){
				if(j%power(2,i)==0)cout<<setw(15)<<left<<data[pos],pos++;
				else cout<<"       ";
			}
			pos/=4;
			cout<<endl;
