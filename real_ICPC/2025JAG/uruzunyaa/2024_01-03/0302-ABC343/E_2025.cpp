...
int main(){
	...
	rep(a,15)rep(b,15)rep(c,15){
		rep(x,15)rep(y,15)rep(z,15){
			...
			one-=two*2;
			ll three=0;
			three+=max(0LL,min(7LL,min(a,x))+7-max(7LL,max(a,x)))*max(0LL,min(7LL,min(b,y))+7-max(7LL,max(b,y)))*max(0LL,min(7LL,min(c,z))+7-max(7LL,max(c,z)));
			two-=three*3;
			one+=three*3;
