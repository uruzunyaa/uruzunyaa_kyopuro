...
int main(){
	...
	if(s.size()==2){
		ll n=stoll(s);
		if(n==10)cout<<-1<<endl;
		else if(n<=20)cout<<20<<endl;
		else if(n<=40)cout<<-1<<endl;
		else if(n<=80)cout<<80<<endl;
		else cout<<110<<endl;
		return 0;
	}
	//return 1;
	...
	ll n=stoll(t);
	if(n==100)cout<<110;
	else if(n<200)cout<<200;
	else if(n<220)cout<<224;
	else if(n<400)cout<<440;
	else if(n<800)cout<<800;
	else cout<<1100;

	rep(i,s.size()-3)cout<<0;
	cout<<endl;
	return 0;
}
