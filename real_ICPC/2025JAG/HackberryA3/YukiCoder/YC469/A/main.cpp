...
int solve() {
	unordered_set<string> onecoder = {
		"gray","brown","green","cyan","blue","yellow","orange","red"
	};
	unordered_set<string> twocoder = {
		"gray","green","blue","yellow","red"
	};
	unordered_set<string> threeforces = {
	...
	ll ok = 0;
	do {
		if (onecoder.count(s[0]) && twocoder.count(s[1]) && threeforces.count(s[2])) {
			ok += 1;
		}
